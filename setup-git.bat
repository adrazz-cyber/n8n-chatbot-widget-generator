...
REM Initial commit
git commit -m "Initial commit: N8N Chatbot Widget Generator v1.0 - Features: Visual configuration interface, Real-time preview, Customisable colours and fonts, Save/load configurations, One-click code generation, Responsive design"
